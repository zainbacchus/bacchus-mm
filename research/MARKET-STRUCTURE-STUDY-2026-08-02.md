...
3. `jump_study.py`: separates TREND (24h range) from JUMPS (max move in any 5min)
...
concentrates at 1c spreads (178 markets with >10k/day at 1c), i.e. the
...
because markets price it away. If it were calm and wide, the 1c-tick pros would
compress it. The 2-4c spread you see IS the premium demanded for 22c jump risk,
and that premium is sized for someone who requotes in microseconds.

Therefore option B (pivot to flow) is NOT viable for a passive quoter at retail
latency. Option A (calm markets) has spread but almost no flow, plus a measured
...
That is arbitrage rather than making. It takes instead of quotes, needs
mispricing persistence rather than speed, and has defined risk. See ROADMAP
"Strategy candidates".
